...
CREATE TYPE "public"."taxon_rank" AS ENUM('domain', 'kingdom', 'phylum', 'class', 'subclass', 'order', 'family', 'subfamily', 'tribe', 'genus', 'species', 'subspecies', 'variety');--> statement-breakpoint
CREATE TABLE "names" (
